...
/**
 * Button.java - This class is meant to replace the JButton swing member.  It improves the
 * functionality of the original class by adding mouse press and mouse release actions.  Also it
 * applies my default styling to the object.
 * @version     1.0.0
 * @package     CloudClip.Graphic
 * @category    Button
