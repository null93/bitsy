...
/**
 * TextField.java - This class is meant to replace the JTextField swing member.  It improves the
 * functionality of the original class by adding placeholder support.  Also it applies my default
